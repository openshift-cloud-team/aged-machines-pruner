...
Do not forget to clean up the example results:
...
without the necessity to build a container image and organize its delivery into the cluster.
However, for complex programs, it is better to build a separate image,
